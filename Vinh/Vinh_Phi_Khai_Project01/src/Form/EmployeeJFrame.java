...
public class EmployeeJFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        if (tbJtable.getColumnModel().getColumnCount() > 0) {
            tbJtable.getColumnModel().getColumn(0).setMinWidth(150);
            tbJtable.getColumnModel().getColumn(0).setMaxWidth(250);
            tbJtable.getColumnModel().getColumn(2).setMinWidth(100);
            tbJtable.getColumnModel().getColumn(2).setMaxWidth(150);
        }
